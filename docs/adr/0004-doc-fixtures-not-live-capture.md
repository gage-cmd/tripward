...
Decision: Check in documentation fixtures copied from the official hooks reference (2026-09-06, https://code.claude.com/docs/en/hooks.md) under `fixtures/claude-hooks/`. Label them as documentation fixtures, not live dumps. Synthetic trips use those payloads through `fusecap hook` / the documented stub.
