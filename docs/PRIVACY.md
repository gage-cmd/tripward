...
If you send evidence, send redacted JSON — not `.env`, transcripts, prompts, or repo contents. Usage dollars stay null unless a separately supported observable API/BYOK boundary is active.
